    ...
    const initializeAndFetch = async () => {
      try {
        ...
        setError(
          err instanceof Error
            ? err.message
            : 'Failed to initialize trading strategy'
        );
        setInitializing(false);
      }
    };
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                {marketData.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <p>
                      24h High: $
                      {marketData[marketData.length - 1].high.toFixed(2)}
                    </p>
                    <p>
                      24h Low: $
                      {marketData[marketData.length - 1].low.toFixed(2)}
                    </p>
                    <p>
                      24h Volume:{' '}
                      {marketData[marketData.length - 1].volume.toFixed(2)}
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                {prediction !== null && (
                  <div className="space-y-2">
                    ...
                    <p
                      className={`font-bold ${getSignalColor(getSignalStrength())}`}
                    >
